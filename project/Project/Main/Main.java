...
public class Main extends Application {
    ...
    private ImageView alertImg = new ImageView(new Image(getClass().getResourceAsStream("/img/alert.png")));
    ...
    public void start(Stage primaryStage) {
        ...
        // Alert ToolTip
        Tooltip alertTip = new Tooltip("This ID already exist");
        alertTip.setStyle("-fx-font-size: 12; -fx-font-weight:bold; -fx-text-fill: #fee96f;");
        
        alertImg.setVisible(false);
        alertImg.setFitWidth(25);
        alertImg.setFitHeight(25);
        Tooltip.install(alertImg, alertTip);
        gridpane.add(alertImg, 2, 0);
        GridPane.setValignment(alertImg, VPos.TOP);
        ...
        birthTxtField.setPromptText("dd/mm/yyyy");
    ...
    public String scanId(String id){
        ...
        return null; // return null ( no id found )
    }
